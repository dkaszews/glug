...
MAGISK = Repo('https://github.com/topjohnwu/Magisk.git', 'v30.6')
JQ = Repo('https://github.com/jqlang/jq.git', 'jq-1.8.1')
OBS = Repo('https://github.com/obsproject/obs-studio.git', '32.0.4')
